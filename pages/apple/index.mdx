...
3. Don't bucket, let things undefined be
...
care and collaborate with corporate dev “partners”, but that's different.
...
Apologies for the snide, I know some great people who work at Google. My point
is that Google isn't fixing this bug not because it doesn’t know how to, but
...
heartfeltly thanked Steve Jobs.
...
Even if there were no apps in my phone, I would still buy an iPhone. For myself
likely, but most certainly for her.
...
Apple’s part, as there are many individuals working at Apple who do care about
...
situation. With the APIs out, I'd thought maybe things will change.
...
just all seem to go for the same generic “Spotify” approach to music.
...
> provide a seamless, endless _yet_ still personal approach to music.
>
> That era is not coming back because it relied on piracy, but luckily that's
> not a problem! and that's the great thing about Apple Music's catalog. We can
> recreate that experience without needing to sail the high seas.

Enough of the backstory. So I recently had a bunch of free time, and thought
that I’ll write a player. Mostly for myself, but I also wanted to write a
...
pay Apple 100 bucks just to try things out. And it also partially explains why
