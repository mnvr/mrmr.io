---
title: It is not words that are the problem, it is the attachment to them
date: 2023-11-09
# theme: text
unlisted: true
layout: basic
...
It is not words that are the problem, it is the attachment to them. Fine, I say,
I’ll just use words without getting attached to them.

> (Here, I use the word “word” to the mean words, concepts,
> ideas, theory patterns, and language itself)
