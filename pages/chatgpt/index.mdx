...
date: 2024-01-10
description: A recipe for an existential crisis
theme: paper
layout: text
tags:
    - tag: rant
...
3. Talking to a non-sentient intelligence has a creepy vibe

Luckily for me, I don't need to convince anyone about my points, because reason
1 is already well understood, and is already driving non natural language
interfaces to language models.

> When Alexa first came to the scene, many, including me, thought that all apps
> will become a conversational UI. Time, as it usually does, prove me wrong.
>
> People have learnt from that, and now they know that specialized interfaces,
> with specialized prompts, are going to form the bulk of interactions with
> LLMs, and that’s what they’re building.
...
as a UX review – if you're building interfaces on top of LLMs, you might find it
interesting to hear about experiences like mine, and maybe even cater for it.
...
coevolve](/ai-religion), and there is no on-principle grudge I have against
using them. So I was sort of puzzled why inspite of liking them _and_ wanting to
use them more, in practice I didn’t use them as much I would've expected.
...
Reason 3 is the new pattern I recognized after a recent episode, and it's the
one that triggered me writing this post.
...
getting too caught up in writing code bit. Programming is one level up: problems
can sometimes be solved directly too.
...
Haha! So I gave it the file. Or part of it. I wasn’t sure how much the context
...
But that’s not the point of my post. I’m sure there already exist better
versions of ChatGPT that can follow these instructions unblemished, and have a
context limit large enough that I don’t need to split my task into chunks. The
problem is not that it didn't do a perfect job.
...
input and watching it do the same thing over and over again gave me an
existential crisis.
...
As the display scrolled with lines and lines unending CSS, and time after time,
14 times, I repeated the prompt so that it doesn't forget, each time it answered
YES. Sometimes a cheerful, immediate _YES_, sometimes a delayed, disgruntled
_Yes_, but never (yet) a _NO_. And all this gave me a sinking feeling.
...
I started wondering if there really was any difference in what I was doing to
ChatGPT, and what my subconscious was doing to me. I was sat there, trying to
clean up some CSS for some reason that a thought had arosen in me that I should
do it as part of some other goal that had arisen in me. I don’t know how those
goals arise. I can give post-hoc explanations, sure, but I fundamentally don’t
know at whose commands, nature, genetics or a malevolent god, I am doing the
things I am doing.

Having had nineteen existential crises before it, I knew it would pass, and it
did. But it did get me thinking. Maybe talking really isn't the best way to
