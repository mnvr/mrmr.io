...
feeling of comprehension was because there actually two different differences at
play:
...
of the technicalities wrong, and I’m certain that there are better expositions
out there of what I’m trying to say here. Or maybe this is too elementary, and
most folks comprehend it all from the get go.
...
after Gauss, and are called _Gaussian Numbers_.
...
when we actually try to do any operations on it.
