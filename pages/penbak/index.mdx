...
produces. But when online, the negative feedback loops – reputation, interactive
communication, body language – that suppress this rage don’t exist.
...
seethe and hate. And it is not even a choice - I might stop calling myself a
programmer (and maybe I should), but that won’t stop me from being one, I just
am one of those nerds.

Now, that doesn’t mean I cannot be kind. I try to. And it also doesn’t mean that
all the people in this bucket are unkind. No.

But it does mean my peer group in life is full of people who don’t understand
that the being right is not important, being kind is.

Some of us are engineers too (programming and engineering are two different
things, but that’s for another day). As engineers, numbers don’t lie, and a kind
engineer is a laughable proposition. We want engineers who are right. But
nowhere does that imply that they have to be unkind.
...
<mark>The problem does not exist in between the computer and the keyboard. If
...
has a downvote / dislike button just cannot survive - humanity is not built on
...
I’m mixing two things here. Designing software requires empathy, and that in
their online interactions people are extra unkind.

I’m mixing them because my audience for this post is programmers, and
...
telling about it to people (to their indifference mostly, and maybe a light
chuckle at me exalting something as silly as shell scripts).

In this mindset, I like starting together the chain of pipes with a cat. Doing
it like that conceptually makes more sense to me, it makes debugging easier, it
makes transplating easier, and I also like the eventual artefact.

I dare you to state this opinion in, say, /r/programming. There will be a line
of smartasses lining up to give you the “useless use of cat award” and with a
shower of acerbism to go along with it.

I have stopped talking about shell scripts because of such people. I still write
them for my own use sometimes, but less and lesser, and I don’t talk about it
anymore. Because I know just like fleas, such lost souls will start pestering
me, and I don’t have a skin thick enough to handle their negativity.
...
because programmers themselves often have neurodivergences that needs a safe
space for them to shine at their best. And then they themselves go out and ruin
the safe spaces other people try to build for them.

Let us try to end this cycle. Let us try to empathise with the user, and let us
