...
date: 2023-12-05
description: Using log files to capture that vibe - an exemplar bash script.
theme: paper
layout: text
# tags:
#     - Programming
...
The <ExternalLink
href="https://github.com/mnvr/advent-of-code-2023/blob/main/03.az.sh">
resultant shell script</ExternalLink> is not structured as functions or
...
If it sounds abstract, have a <ExternalLink
href="https://github.com/mnvr/advent-of-code-2023/blob/main/03.az.sh">gander at
the source code</ExternalLink>. Even if you don’t talk shell script or awk, you
should be able to get the basic flow that I’m hinting at.
