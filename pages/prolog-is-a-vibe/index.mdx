...
shell script</ELink> is not structured as functions or subroutines or steps. It
is instead structured as a set of passes over a database of facts. What database
do we use? It’s own log file!
...
If it sounds abstract, have a <ELink
href="https://github.com/mnvr/advent-of-code-2023/blob/main/03.az.sh">look at
the source code</ELink>. Even if you don’t talk shell script or
