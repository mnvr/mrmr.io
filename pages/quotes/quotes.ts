...
export const quotes: string[] = [
    ...
    "Along the shore the cloud waves break, the twin suns sink behind the lake. The shadows lengthen, in Carcosa. Song of my soul, my voice is dead, Dying, as tears unshed, in lost Carcosa.",
