...
who've been in shot at by well meaning but clueless consistency police with
their state management silver bullets would know what I mean.
...
when I saw it. Watching it, as it sank in, I felt like I had gained a
...
Consider listing the contents of a directory (shoutout to
...
while monads enable composability, monads _themselves_ are not composable (for
