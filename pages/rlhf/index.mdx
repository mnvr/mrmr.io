...
I hope you don't get too hung over the labels I used to describe the contrasting
functions. The necessity of the separate existence of the "RLHF" component, or a
separate physical "right brain" isn't what I'm trying to get at. Instead, I find
it interesting that two different form of intelligences that we've encountered,
ourselves and LLMs, seem to warrant a self-censorship mechanism.
