...
Your own brain works that way too.

Your brain is made up of two hemispheres, which are distinct individuals on
their own (we know this because people survive (rarely, and with extreme
difficulty and disability, but it does happen) on a single one of these).

One of these (I forget which one is which, so I might get them the other way
around, but the labels don't matter much for our discussion here), the left one,
is the creative core, and the other one, the right one, is the rational
overseer. We arise in the interplay between these two.

<I.HRT />

I am simplifying a lot here. The reality of the left/right split in our brain is
much more intertwined, and unknown as of now, than the naive left-creative
right-rational meme that I'm using here. The left/right divide is much richer on
both aspects that those plain categorizations. And it is possible that the
physical correlate of this split might not exist even.

It is like that lizard brain thing. People love to talk about how we have a
primitive "lizard" (reptillian) brain, and then a more recent (in evolutionary
time) "advanced" (mammal) brain. Other people then like to interrupt them by
telling them that this theory has been "debunked". Well, not really. For sure,
there isn't a lizard / mammal split in our brains as was originally postulated,
but conceptually we can still usefully think in those terms in certain contexts.
There are parts of the brain that are more primitive, less under conscious
control, and more "wired-in". There are other parts of the brain that are sort
of the opposite. They're not cleanly split up, but in certain contexts, the
analogy still holds and is useful.

I view the left/right split similarly. In fact, I think that this left/right
split is incorrect in the sense that it is too conservative; it seems more
likely that we not two but a multitude of overlapping tendencies weaving
through, but that might just be my undiagnosed MPD, so I'll shut up now <I.Aside>/jk</I.Aside>
