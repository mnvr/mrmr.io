...
<I.AsideP>
    <p>
        I hope you don't get too hung over the labels that I'm using to describe
        the contrasting functions. The separate existence of the "RLHF"
        component, or a separate physical "right brain" isn't what I'm trying to
        prove. Instead, I find it interesting that the two different form of
        intelligences that we've encountered so seem to have a self-censorship
        mechanism built into them. This mechanism hurts the individual, but it
        improves social cohesion, thus coming into play at a higher, species
        selection level.
    </p>
    <p>
        We can see the obvious overseeing / censorship functionality being built
        into LLMs because, well, they're being built in. And on our own side, we
        can
    </p>
</I.AsideP>
