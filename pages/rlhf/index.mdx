...
We can think of a LLM as a black box which when given a sequence of text,
predicts the next word that is the most likely. Most likely in which sense?
Suppose that we get 10 people in a room, give them a sequence of text, let us
say
...
<I.AsideP>This comparison of a LLM to an average of 10 million people is helpful
to get a basic gist of what's going on, but be aware that it is a flawed
comparison ultimately. To see how, consider this: would you rather fight 100
duck sized Obamas or one Obama sized duck? </I.AsideP>
