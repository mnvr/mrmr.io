...
is why code has been the highest fidelity approach we've had to capture the
...
the ability to converse in them. Or maybe not, since maybe code is not just
linear like sentences, and it has a fraction more dimension than that. Not quite
2D, but something like 1.3, like a poem.
...
even exist in material space, but is the basis of the physical computer that I
write these words on, and whose laws make possible the programming languages
that animate the souls of those machines.
