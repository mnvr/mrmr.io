...
is moving around in its environment in the hours after hatching as their mother.
...
Critical periods have measurable neurobiological markers. Psychologically the
effect seems to be that the brain is more "open" for some modality during its
corresponding critical period.
...
not easily, because the brain is neurobiologically not open anymore to
"overwrite" what got imprinted. PTSD is a canonical example, but it's not the
only one. Various psychiatric issues can be traced back to problematic imprints.

So far, I've described what critical periods are, and why they're important.
From my understanding, all this is fairly accepted current scientific consensus
(e.g. https://www.ncbi.nlm.nih.gov/pmc/articles/PMC6526538/)
