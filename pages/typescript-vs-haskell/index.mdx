...
TypeScript provides **structural typing**. If it walks like a duck, and quacks
like a duck, for TypeScript, it is a duck. TypeScript does not care at all what
name you give to the type.

Haskell provides **nominal typing**. It must be called a duck for it to be
