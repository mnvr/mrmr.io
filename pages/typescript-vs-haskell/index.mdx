...
TypeScript provides <E.InvertedColorStrong>structural
typing</E.InvertedColorStrong>. If it walks like a duck, and quacks like a duck,
for TypeScript, it is a duck. TypeScript does not care at all what name you give
to the type.

Haskell provides <E.InvertedColorStrong>nominal typing</E.InvertedColorStrong>.
It must be called a duck for it to be considered a duck. A rose by any other
name won’t do.
