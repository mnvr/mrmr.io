...
export interface Page {
    ...
    /**
     * An image generated by applying the page colors to the default template
     * preview image.
     *
     * This will only be present if the page doesn't have an associated preview
     * image, and if it has explicitly listed colors (not a theme).
     *
