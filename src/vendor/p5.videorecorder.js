// Modified from https://github.com/calebfoss/p5.videorecorder
//
// Original:
...
export class VideoRecorder {
    ...
    set input(input) {
        ...
        if (input === undefined) {
            ...
            if (
                typeof soundOut !== "undefined" &&
                soundOut.output !== undefined
            )
    ...
    #mediaElementToStream(mediaElement) {
        if (typeof mediaElement.captureStream !== "function")
            return console.error(
                `Can't capture stream from input ${mediaElement}`
            );
